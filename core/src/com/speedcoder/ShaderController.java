...
public class ShaderController {
    private FrameBuffer frameBuffer, frameBuffer1;
    private TextureRegion frameBufferRegion , frameBufferRegion1;
    ...
    public ShaderController(CodeSpeed codeSpeed){
        ...
        Pixmap pixmap = new Pixmap(width/32,height/32, Pixmap.Format.RGBA8888);
    ...
    public void drawShader(Stage stage){
        ...
        codeSpeed.batch.begin();
        codeSpeed.batch.draw(frameBufferRegion1,0,0);
        codeSpeed.batch.end();
